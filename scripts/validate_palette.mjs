...
// Node CLI
if (typeof process !== "undefined" && process.argv && process.argv[1] && /validate_palette\.(js|mjs)$/.test(process.argv[1])) {
  ...
  if (!palette.length) { console.error("usage: node validate_palette.mjs \"#hex,#hex,...\" [--mode light|dark] [--surface #hex] [--pairs adjacent|all] [--ordinal]"); process.exit(2); }
